...
namespace Samples.CoconutWaxWallet.Scripts.UI.Tools
{
    ...
    public static class UISafeAreaFitter
    {
        public static void FitInSafeArea(this RectTransform trans)
        {
            ...
            Log(
                $"Safe area applied to {trans.name}: x={safeAreaRect.x}, y={safeAreaRect.y}, w={safeAreaRect.width}, h={safeAreaRect.height} on full extents w={Screen.width}, h={Screen.height}",
                LogType.Verbose);
        }
